...
//    }
    ...
    public static function faq()
    {
        ...
        $main_categories=Category::where('parent_id', null)->with(['children' => function ($query) {
            $query->has('faqs');
        }])->withTranslations(App::getLocale())->get();
        return view('front.pages.single.faq.includes.faq', compact(['faqs', 'main_categories']))->render();
        // });
    }
